...
public class Register2Activity extends AppCompatActivity {
    ...
    private ProgressBar progressBarSign2;
    ...
    private void initUI() {
        ...
        progressBarSign2 = findViewById(R.id.progressBarSign2);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        progressBarSign2.setVisibility(View.GONE);
    ...
    private void createProfile(String userId, String gender, String dateOfBirth, String allergies, float weight, float height) {
        progressBarSign2.setVisibility(View.VISIBLE);
            ...
            public void onResponse(Call<CreateProfileResponse> call, Response<CreateProfileResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(Register2Activity.this, "Error parsing response", Toast.LENGTH_SHORT).show();
                    }
                }
            }
